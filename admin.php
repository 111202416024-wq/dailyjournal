...
<!-- content end -->
    ...
    <div>
        <a href="https://www.instagram.com/ftrna0_0?igsh=MTZhbmUycDN3YmY4YQ=="
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://x.com/ADEAYUFITRIANA3?t=jIOh-eAZJsa2UHlGNE66LA&s=09"
        ><i class="bi bi-twitter h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6289509814543"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div>Ade Ayu Fitriana&copy; 2025</div>
    </footer>
    <!-- footer end -->
    <script
